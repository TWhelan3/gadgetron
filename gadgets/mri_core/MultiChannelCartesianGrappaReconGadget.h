/** \file   MultiChannelCartesianGrappaReconGadget.h
...
namespace Gadgetron {
    ...
    /// define the recon status of MultiChannelCartesianGrappaRecon
    template <typename T>
    class EXPORTGADGETSMRICORE MultiChannelCartesianGrappaReconObj
    {
    public:

        MultiChannelCartesianGrappaReconObj() {}
        virtual ~MultiChannelCartesianGrappaReconObj() {}
...
namespace Gadgetron {
    ...
    class EXPORTGADGETSMRICORE MultiChannelCartesianGrappaReconGadget : public Gadget1<IsmrmrdReconData>
    {
    public:
        GADGET_DECLARE(MultiChannelCartesianGrappaReconGadget);

        typedef Gadget1<IsmrmrdReconData> BaseClass;
        typedef Gadgetron::MultiChannelCartesianGrappaReconObj< std::complex<float> > ReconObjType;

        MultiChannelCartesianGrappaReconGadget();
        ~MultiChannelCartesianGrappaReconGadget();
